...
\begin{document}
	...
	\include{___textual/capitulo1.tex}
	\newpage \thispagestyle{empty}
	
	\include{___textual/capitulo2.tex}
	\newpage \thispagestyle{empty}
	
	\include{___textual/capitulo3.tex}
	\newpage \thispagestyle{empty}
	
	\include{___textual/capitulo4.tex}
	\newpage \thispagestyle{empty}
	
	\include{___textual/capitulo5.tex}
	\newpage \thispagestyle{empty}
	
	\include{___textual/capitulo6.tex}
	\newpage \thispagestyle{empty}
	...
	%\backmatter % marca o início da parte pós-textual
 	...
 	\include{___postextual/apendice1.tex}	
 	\newpage \thispagestyle{empty}
